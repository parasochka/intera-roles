...
<?php
/*
 * The Method band and the closing box are a partial now: the three `/roles/*`
 * landings close on the same two, so they are written once and this page passes
 * its own post as the source of their words — which is what it has always been.
 */
get_template_part(
	...
	array(
		...
		'cta_url'   => $intera_has_cta ? $intera_cta_url : '',
	)
);
