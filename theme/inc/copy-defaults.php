			...
			'sections' => array(
				...
				'partners' => array(
					...
					'fields' => array(
						...
						'home_partners__role_packages' => __( 'Role packages', 'intera' ),
					),
				),
			),
		),
			...
			'sections' => array(
				...
				'role_packages' => array(
					...
					'fields' => array(
						...
						'product_role_packages__beta' => __( 'Beta', 'intera' ),
					),
				),
				'method' => array(
			...
			'sections' => array(
				...
				'request_form' => array(
					...
					'fields' => array(
						...
						'request_request_form__free_for_the_first_12_months' => __( 'Free for the first 12 months, unlimited roles, custom onboarding and one role package included. We take a small number of companies during beta.', 'intera' ),
